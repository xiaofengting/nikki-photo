...
<template>
  <div :class="{
    ...
    <div class="right-block">
      ...
      <CollapseFace :heart="parts.heart" :tear="parts.tear" :star="parts.star" :red="parts.red"
        @choose-face="chooseFace" />
      <CollapseNormal v-for="item in PartNormalData" v-bind="item" :active="parts[item.unit]"
        :active-color="parts[item.unitColor || 'frontHairColor']" @choose-part="choosePart"
        @choose-color="chooseColor" />
      <CollapseNormal v-if="parts.doubleMode" v-for="item in PartLeftData" v-bind="item" :active="parts[item.unit]"
        :active-color="parts[item.unitColor || 'frontHairColor']" @choose-part="choosePart"
        @choose-color="chooseColor" />
      <CollapseNormal v-for="item in PartDecorateData" v-bind="item" :active="parts[item.unit]"
        :active-color="parts[item.unitColor || 'frontHairColor']" @choose-part="choosePart"
        @choose-color="chooseColor" />
    </div>
